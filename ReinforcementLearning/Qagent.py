...
epsilon_decay_value = epsilon/(END_EPSILON-EPSILON_DECAY)
# Remove duplicate/incorrect epsilon and decay definitions above
# Create the environment
env = gym.make("MountainCar-v0", render_mode="human" if SHOW_EVERY > 0 else None)

# Discretization settings
DISCRETE_OS_SIZE = [20, 20]  # size of the discretized state space
...
for episode in range(EPISODES):
    ...
    while not done:
        ...
        # New Gymnasium API returns 5 values
